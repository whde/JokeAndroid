...
public class JokeSwipeRefreshLayout extends SwipeRefreshLayout {

    private static final String TAG = JokeSwipeRefreshLayout.class.getSimpleName();
    ...
    public JokeSwipeRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        // 填充底部加载布局
